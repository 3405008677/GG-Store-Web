      ...
      <div class="hero-center">
        <article class="hero-banner">
          <div class="hero-banner__content">
            <span class="hero-banner__eyebrow">GG STORE · ONE-STOP PROCUREMENT</span>
            <h1>正品现货<br /><strong>一站式</strong>工业采购</h1>
            <p>从电子元器件到工业用品，为研发、打样与量产提供稳定供应。</p>
...
.hero-banner {
  ...
  color: #fff;
  background:
    linear-gradient(118deg, rgb(8 56 134 / 98%) 0%, rgb(22 111 218 / 96%) 58%, rgb(29 132 226 / 92%) 100%),
    #1768d7;
  border-radius: 3px;
